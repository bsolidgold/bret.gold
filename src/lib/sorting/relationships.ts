...
export const RELATIONSHIP_CONFIGS: Record<RelationshipType, RelationshipConfig> =
  {
    "inner-circle": {
      ...
      autoOpenFloors: [0, 3, 5, 8, 9, 11],
      autoGatedFloors: [1, 4, 6, 10, 12],
      requestableFloors: [7],
      skipQuestions: false,
    },
    "bjj-friend": {
      ...
      autoOpenFloors: [0, 3, 8, 11],
      autoGatedFloors: [10],
      requestableFloors: [1, 4, 12],
      skipQuestions: false,
    },
    "recovery-friend": {
